...
description: >-
  ...
  Kết nối và điều phối bộ 6 skill chuyên sâu: arrchirio-canon (Bảo vệ Canon & Hard Magic),
  arrchirio-style (Văn phong & Khử AI Slop), arrchirio-story-review (Chẩn đoán cốt truyện & Scene Engine),
  arrchirio-chapter-writer (Chấp bút SOP 6 bước), arrchirio-worldbuilder (Mở rộng thế giới Proposal-First),
  và arrchirio-illustrator (Mỹ thuật thị giác & Tranh minh họa Light Novel).
---
...
Khi Showrunner đưa ra yêu cầu sáng tác chung hoặc cần định tuyến công việc, `novel-craft` sẽ xác định chính xác năng lực nào cần được kích hoạt từ bộ **6 Skill Chuyên Biệt**:
...
flowchart TD
    ...
    NC --> AI[arrchirio-illustrator<br/>Mỹ Thuật Thị Giác & Minh Họa]

    AC -.->|Khóa quy chuẩn| AW
    AS -.->|Bộ lọc văn phong| AW
    AR -.->|Thẩm định chất lượng| AW
    AB -.->|Đề xuất mới| AC
    AC -.->|Khóa ngoại hình canon| AI
```

---

## 1. Bản Đồ Điều Phối 6 Skill Chuyên Biệt
...
| **Vẽ minh họa, concept nhân vật, bìa sách, prompt Midjourney/SDXL** | Khóa nhận diện nhân vật, tạo bìa 2:3, đại cảnh 16:9, xuất prompt đa nền tảng. | 🎨 `arrchirio-illustrator` |
